...
if __name__ == '__main__':  
    ...
    for u in uList:
        print 'counting', u
        wbWc = wbCountWc(uWeiboDict[u])
        infoWc = infoCountWc(uInfoDict[u])
        infoWcDict[u] = infoWc
        wbWcDict[u] = wbWc

    #for k in wbWcDict:
    #    for kk in wbWcDict[k]:
    #        print k, kk, wbWcDict[k][kk]
    
    dump(wbWcDict, infoWcDict)
